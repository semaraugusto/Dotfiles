...
#   fi
#
#   PS1="${txt} \[\e[33m\]\w \[\e[38;5;20m\]\D{%F %T}\[\e[0m\]\n\$ "
# }
#
...
bind '"\C-atc": "todoist list | fzf | cut -d \" \" -f 1 | xargs -I {} todoist close "{}"\n" '
bind '"\C-atk": "todoist list | fzf | cut -d \" \" -f 1 | xargs -I {} todoist delete "{}"\n" '
bind '"\C-atm": "todoist list | fzf | cut -d \" \" -f 1 | xargs -I {} todoist modify \"{}\" -c " '
bind '"\C-atl": "todoist list | fzf | cut -d \" \" -f 1 | xargs -I {} todoist show "{}"\n"'
bind '"\C-atp": "todoist --project-namespace projects | fzf | cut -d \" \" -f 2 | xargs -I {} todoist list -f "{}"\n"'
