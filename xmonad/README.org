...
myScratchPads = [ NS "terminal" spawnTerm findTerm manageTerm
                ...
                , NS "1password" spawnPass findPass manageCalc
                ]
  where
    ...
    manageCalc = customFloating $ W.RationalRect l t w h
               where
                 ...
                 t = 0.75 -h
                 l = 0.70 -w
    spawnPass  = "/usr/bin/1password"
    findPass   = className =? "1Password"
    managePass = (customFloating (W.RationalRect 0.1 0.1 0.8 0.8))
#+END_SRC

#+RESULTS:
: <interactive>:175:17: error:
...
myKeys =
    ...
    -- KB_GROUP Useful programs to have a keybinding for launch
        , ("M-<Reh", spawn (myTerminal ++ " -e htop"))

    -- KB_GROUP Kill windows
        , ("M-S-q", kill1)              -- Quits xmonad
